...
ImageIcon EBlanco = new ImageIcon("C:\\Users\\Juancho956\\Documents\\Ejercicios Progra 2022\\Progra 2022\\Ejercicios Abril\\ProectoFinal\\src\\main\\java\\Imagenes\\espacioblanco.png");
    ...
    private void BotonCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonCargarActionPerformed
        int partida = Integer.parseInt(JOptionPane.showInputDialog(null,"Ingrese el numero de partida que quiere cargar"));
        for(int y = 0; y < 8; y++){
            for(int x = 0; x < 8; x++){
                Tablero[x][y] = PartidasGuardadas.CARGARTablero(x, y, partida);
                System.out.print(Tablero[x][y] + " ");
                imagen[x][y].setEnabled(true);
            }    
        System.out.println(" ");
        }    
        Jugador1 = PartidasGuardadas.CARGARJ1(partida);
        Jugador2 = PartidasGuardadas.CARGARJ2(partida);
        ImagenesBotones();
        tiempo();
        moverPieza();
        GuardarPartidaButton.setEnabled(true);
